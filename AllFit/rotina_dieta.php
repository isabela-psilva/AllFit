<?php
    ...
    if ($tem_dieta) {
        ...
        /*
         * Lista de restrições utilizadas no sistema.
         */
        $nomes_restricoes = array(
            1 => "Laticínios",
            2 => "Glúten",
            3 => "Oleaginosas",
            4 => "Leguminosas",
        ...
        while ($restricao = mysql_fetch_assoc($sql_restricoes)) {
            ...
            $id_restricao = $restricao["id_restricao"];

            if (isset($nomes_restricoes[$id_restricao])) {

                $restricoes[] = $nomes_restricoes[$id_restricao];
                        ...
                        <div class="texto-topo">
                            ...
                            <div>
                                ...
                                <button
                                    ...
                                    onclick="window.location.href='dieta.php?editar=true'">
                                    Editar meu plano
                                </button>
